...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_APlayerPawn_Statics::NewProp_Speed = { "Speed", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(APlayerPawn, Speed), METADATA_PARAMS(Z_Construct_UClass_APlayerPawn_Statics::NewProp_Speed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APlayerPawn_Statics::NewProp_Speed_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APlayerPawn_Statics::NewProp_TurnRate_MetaData[] = {
		{ "Category", "Movement" },
		{ "ModuleRelativePath", "Public/PlayerPawn.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_APlayerPawn_Statics::NewProp_TurnRate = { "TurnRate", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(APlayerPawn, TurnRate), METADATA_PARAMS(Z_Construct_UClass_APlayerPawn_Statics::NewProp_TurnRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APlayerPawn_Statics::NewProp_TurnRate_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_APlayerPawn_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APlayerPawn_Statics::NewProp_TurnRate,
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_Fals3_Desktop_Summer_Repo_ProjectMetaRacers_ProjectMetaRacers_ProjectMetaRacers_Source_ProjectMetaRacers_Public_PlayerPawn_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Fals3_Desktop_Summer_Repo_ProjectMetaRacers_ProjectMetaRacers_ProjectMetaRacers_Source_ProjectMetaRacers_Public_PlayerPawn_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_APlayerPawn, APlayerPawn::StaticClass, TEXT("APlayerPawn"), &Z_Registration_Info_UClass_APlayerPawn, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APlayerPawn), 1619892756U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Fals3_Desktop_Summer_Repo_ProjectMetaRacers_ProjectMetaRacers_ProjectMetaRacers_Source_ProjectMetaRacers_Public_PlayerPawn_h_657504446(TEXT("/Script/ProjectMetaRacers"),
		Z_CompiledInDeferFile_FID_Users_Fals3_Desktop_Summer_Repo_ProjectMetaRacers_ProjectMetaRacers_ProjectMetaRacers_Source_ProjectMetaRacers_Public_PlayerPawn_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Fals3_Desktop_Summer_Repo_ProjectMetaRacers_ProjectMetaRacers_ProjectMetaRacers_Source_ProjectMetaRacers_Public_PlayerPawn_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
